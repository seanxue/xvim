...
return {
	...
	-----------------------------------------------------------------------------
	{
		...
		keys = {
			...
			{ '<localleader>t', '<cmd>Telescope lsp_document_symbols symbol_width=50<CR>', desc = 'Document symbols' },
			{ '<localleader>T', '<cmd>Telescope lsp_dynamic_workspace_symbols symbol_width=50<CR>', desc = 'Workspace symbols' },
